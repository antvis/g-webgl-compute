...
function peg$parse(input: string, options?: IParseOptions) {
  ...
  const peg$c43 = function(head: any, tail: any, type: any): any {
    let dataType = extractOptional(type, 4) || [];
    return {
      type: 'Identifier',
      name: head + tail.join(''),
  ...
  const peg$c330 = function(name: any, others: any, moduleName: any): any {
    return {
      ...
      source: moduleName,
      specifiers: resolveList(name, others, 3).map((v) => ({
  ...
  const peg$c334 = function(defaultSpecifier: any, moduleName: any): any {
    return {
      ...
      source: moduleName,
      specifiers: [
        { type: 'ImportNamespaceSpecifier', local: defaultSpecifier },
      ],
    };
  };
