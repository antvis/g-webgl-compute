...
describe('Parser', () => {
  ...
  test('should generate AST for ExportDeclaration.', () => {
    ...
    expect((declaration.declaration as FunctionDeclaration).params.length).toBe(
      0,
    );
    ...
    expect(
      (declaration.declaration as FunctionDeclaration).body.body.length,
    ).toBe(0);
  });
  ...
  test('should generate AST for typeAnnotation.', () => {
    ...
    expect(declaration.declarations[0].type).toBe(
